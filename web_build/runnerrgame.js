...
// include: C:\Users\JP\AppData\Local\Temp\tmp7ku9zsy5.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'runnerrgame.data';
      var REMOTE_PACKAGE_BASE = 'runnerrgame.data';
...
Module['FS_createPath']("/src", "Sprites", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          Module['removeRunDependency']('datafile_runnerrgame.data');
      }
      Module['addRunDependency']('datafile_runnerrgame.data');
    ...
    loadPackage({"files": [{"filename": "/src/Sprites/background.png", "start": 0, "end": 552}, {"filename": "/src/Sprites/bird.png", "start": 552, "end": 4255}, {"filename": "/src/Sprites/floor_tiles.png", "start": 4255, "end": 6463}, {"filename": "/src/Sprites/frog_run.png", "start": 6463, "end": 8653}, {"filename": "/src/Sprites/runner.png", "start": 8653, "end": 12429}], "remote_package_size": 12429});

  })();

// end include: C:\Users\JP\AppData\Local\Temp\tmp7ku9zsy5.js
// include: C:\Users\JP\AppData\Local\Temp\tmpzygvuhq9.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\JP\AppData\Local\Temp\tmpzygvuhq9.js
// include: C:\Users\JP\AppData\Local\Temp\tmpc0t2rpyv.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\JP\AppData\Local\Temp\tmpc0t2rpyv.js
...
function findWasmBinary() {
    return locateFile('runnerrgame.wasm');
}
...
var ASM_CONSTS = {
  97720: () => { if (document.fullscreenElement) return 1; },  
 97766: () => { return Module.canvas.width; },  
 97798: () => { return parseInt(Module.canvas.style.width); },  
 97846: () => { document.exitFullscreen(); },  
 97873: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 97946: () => { if (document.fullscreenElement) return 1; },  
 97992: () => { return Module.canvas.width; },  
 98024: () => { return screen.width; },  
 98049: () => { document.exitFullscreen(); },  
 98076: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 98209: () => { return window.innerWidth; },  
 98235: () => { return window.innerHeight; },  
 98262: () => { if (document.fullscreenElement) return 1; },  
 98308: () => { return Module.canvas.width; },  
 98340: () => { return parseInt(Module.canvas.style.width); },  
 98388: () => { if (document.fullscreenElement) return 1; },  
 98434: () => { return Module.canvas.width; },  
 98466: () => { return screen.width; },  
 98491: () => { return window.innerWidth; },  
 98517: () => { return window.innerHeight; },  
 98544: () => { if (document.fullscreenElement) return 1; },  
 98590: () => { return Module.canvas.width; },  
 98622: () => { return screen.width; },  
 98647: () => { document.exitFullscreen(); },  
 98674: () => { if (document.fullscreenElement) return 1; },  
 98720: () => { return Module.canvas.width; },  
 98752: () => { return parseInt(Module.canvas.style.width); },  
 98800: () => { document.exitFullscreen(); },  
 98827: ($0) => { Module.canvas.style.opacity = $0; },  
 98865: () => { return screen.width; },  
 98890: () => { return screen.height; },  
 98916: () => { return window.screenX; },  
 98943: () => { return window.screenY; },  
 98970: () => { return window.devicePixelRatio; },  
 99006: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 99059: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 99110: () => { Module.canvas.style.cursor = 'none'; },  
 99147: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 99403: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 99454: () => { if (document.pointerLockElement) return 1; },  
 99501: () => { if (document.fullscreenElement) return 1; },  
 99547: () => { return window.innerWidth; },  
 99573: () => { return window.innerHeight; }
};
